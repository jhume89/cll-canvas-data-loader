select acc.id as account_id, acc.name as account_name, c.code as course_code, c.name as course_name, t.sortable_name as latest_term, "" as all_terms, CONCAT(c.code," | ",t.sortable_name) as code_and_term, c.canvas_id as course_canvas_id
from course_dim c
